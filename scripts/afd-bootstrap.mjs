...
const version = option("--version", "0.8.0"); const repository = option("--repository", "smota/ai-foundry-desk"); const prefix = option("--prefix", process.platform === "win32" ? undefined : path.join(homedir(), ".local")); const assetDir = option("--asset-dir", undefined);
