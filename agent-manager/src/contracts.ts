...
export interface Recipe { readonly recipeVersion: 1; readonly id: string; readonly version: string; readonly origin: string; readonly skills: readonly RecipeSkill[]; readonly tools: readonly RecipeTool[]; readonly prerequisites: readonly string[]; readonly checks: readonly string[]; readonly rollback: { readonly managedOnly: true } }
export type RecipeActionKind = "copy-skill" | "install-tool" | "blocked";
