...
export const agentTargets: readonly AgentTarget[] = [
  ...
  { id: "antigravity", displayName: "Antigravity CLI", command: "agy", skills: "supported", profile: "deferred", reason: "Global CLI skills use ~/.gemini/antigravity-cli/skills; profile integration remains deferred." },
