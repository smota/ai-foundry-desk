...
- [Repair sandbox tool access](AGENT-SANDBOX-REPAIR.md)
- [Maintain backups](ENVIRONMENT-OWNERSHIP.md#backup-ownership)

## Understand the system

- [Architecture](ARCHITECTURE.md): modules, boundaries, state, and platform adapters
- [Layer inventory](LAYER-INVENTORY.md): installed products, purposes, owners, and platforms
- [Platform support](PLATFORM-SUPPORT.md): validated environments and support limits
...
- [Release process](RELEASING.md): build, audit, and publication procedure
- [Changelog](../CHANGELOG.md): released changes

`NEXT-SESSION.md` and `TYPESCRIPT-PLATFORM-MIGRATION.md` are maintainer history and handoff records,
not starting points for users.
