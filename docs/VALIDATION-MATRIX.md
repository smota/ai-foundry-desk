...
| Provenance | Workspace and global CLI report AFD 0.9.0 and identify their CLI/runtime paths. |
...
If the toolchain gate fails with access denied, do not run `afd layer1 apply`: expose a
